...
Follow the instructions in the comment provided. You will create a new variable called `accountAgeInt` which will be the truncated, integer version of `accountAge`.